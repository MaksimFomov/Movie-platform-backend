...
public class UserFacadeImpl implements UserFacade {
    ...
    public UserFacadeImpl(UserService userService, UserRegistrationMapper userRegistrationMapper, AuthenticationRequestMapper authenticationRequestMapper, UserMapper userMapper) {
